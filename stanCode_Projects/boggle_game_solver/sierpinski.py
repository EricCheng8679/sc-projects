...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	if order == 0:
		...
		sierpinski_triangle(order - 1, length / 2, upper_left_x, upper_left_y)#左上點開始
		sierpinski_triangle(order - 1, length / 2, upper_left_x + length / 2, upper_left_y) #右邊開始
		sierpinski_triangle(order - 1, length / 2, upper_left_x + length / 4, upper_left_y + length / 2 * 0.866)  # 右下開始
